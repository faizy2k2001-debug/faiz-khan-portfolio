...
export const SKILL_CATEGORIES: SkillCategory[] = [
  {
    title: "Design Tools",
    skills: [
      { name: "Figma", level: 95, iconName: "figma" },
      { name: "Adobe Creative Suite", level: 90, iconName: "adobe" },
      { name: "Spline 3D", level: 80, iconName: "spline" },
      { name: "Cinema 4D", level: 75, iconName: "cinema4d" }
    ]
  },
  {
    title: "Dev Tools",
    skills: [
      { name: "React / Vite", level: 92, iconName: "react" },
      { name: "TypeScript", level: 88, iconName: "typescript" },
      { name: "Tailwind CSS", level: 95, iconName: "tailwind" },
      { name: "Three.js / WebGL", level: 82, iconName: "webgl" }
    ]
  },
  {
    title: "Knowledge",
    skills: [
      { name: "UI/UX & Prototyping", level: 95, iconName: "uiux" },
      { name: "Motion & Interaction", level: 90, iconName: "motion" },
      { name: "Design Systems", level: 88, iconName: "systems" },
      { name: "Typography & Layout", level: 92, iconName: "type" }
    ]
  }
];
